...
public class UserAccountController {
    ...
    private void searchUserAccount(ActionEvent actionEvent) throws ClassNotFoundException, SQLException {
        try {
            ...
            this.populateAndShowUserAccount(userAccount);
        } catch (SQLException var3) {
            var3.printStackTrace();
            this.resultArea.setText("Error occurred while getting employee information from DB.\n" + var3);
            throw var3;
        }
    }
    @FXML
    ...
    private void deleteUserAccount(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        try {
            ...
            this.resultArea.setText("User account deleted! Username: " + this.UserIdText.getText() + "\n");
        } catch (SQLException var3) {
            this.resultArea.setText("Problem occurred while deleting user account " + var3);
            throw var3;
        }
    }
@FXML
